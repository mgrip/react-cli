...
function (_React$Component) {
  ...
  _createClass(TestComponent, [{
    ...
    value: function render() {
      return React.createElement("div", null, "Counter: ", this.state.count);
    }
  }]);
...
test("components should be able to use local state to manage updates", function (done) {
  _index.default.render(React.createElement(TestComponent, {
    ref: componentReference
  }), function () {
    if (componentReference.current) {
      componentReference.current.setState({
        count: 1
      });
    }
  }, 50, function (outputString) {
    updateCount++; // this should get called twice
