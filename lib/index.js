...
function () {
  function StdOutListener() {
    _classCallCheck(this, StdOutListener);

    _defineProperty(this, "listeners", []);
  }

  _createClass(StdOutListener, [{
    key: "onStdout",
    value: function onStdout(callback) {
      this.listeners.push(callback);
    }
  }, {
    key: "dispatch",
    value: function dispatch(stdOutText) {
      this.listeners.forEach(function (listener) {
        return listener(stdOutText);
      });
    }
  }]);
...
var stdOutListener = new StdOutListener();
exports.stdOutListener = stdOutListener;
