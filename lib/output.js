  ...
  _createClass(RowOutput, [{
    ...
    value: function padText(_ref3) {
      ...
      switch (this.section.align) {
        case "left":
          innerText = text + "".padStart(innerWidth - (0, _stripAnsi.default)(text).length, spacing);
          break;

        case "right":
          innerText = "".padStart(innerWidth - (0, _stripAnsi.default)(text).length, spacing) + text;
          break;

        default:
          innerText = "".padStart((innerWidth - (0, _stripAnsi.default)(text).length) / 2, spacing) + text + "".padStart((innerWidth - (0, _stripAnsi.default)(text).length) / 2 + (innerWidth - (0, _stripAnsi.default)(text).length) % 2, spacing);
          break;
    ...
    value: function generateOutput(_ref4) {
      ...
      this.rows.forEach(function (child) {
        if (currentLineIndex >= tempLineIndex && (!_this2.section.maxHeight || currentLineIndex < tempLineIndex + _this2.section.maxHeight) && currentLineIndex < tempLineIndex + child.getLineLength()) {
...
function () {
  ...
  _createClass(ColumnOutput, [{
    ...
    value: function padText(_ref6) {
      ...
      switch (this.section.align) {
        case "left":
          innerText = text + "".padStart(columnWidth - (0, _stripAnsi.default)(text).length, spacing);
          break;

        case "right":
          innerText = "".padStart(columnWidth - (0, _stripAnsi.default)(text).length, spacing) + text;
          break;

        default:
          innerText = "".padStart((columnWidth - (0, _stripAnsi.default)(text).length) / 2, spacing) + text + "".padStart((columnWidth - (0, _stripAnsi.default)(text).length) / 2 + (columnWidth - (0, _stripAnsi.default)(text).length) % 2, spacing);
          break;
      }
    ...
    value: function generateOutput(_ref7) {
      ...
      this.columns.forEach(function (column, columnIndex) {
        if (currentLineIndex >= startLineIndex + topBorderLength + column.getLineLength() && (!_this4.section.maxHeight || currentLineIndex < startLineIndex + _this4.section.maxHeight)) {
