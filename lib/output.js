...
function () {
  ...
  _createClass(RowOutput, [{
    ...
    value: function getLineLength() {
      ...
      return (this.section.maxHeight ? this.section.maxHeight : rowsLineLength) + this.section.border.verticalHeight();
    }
  }, {
    key: "padText",
...
function () {
  ...
  _createClass(ColumnOutput, [{
    ...
    value: function getLineLength() {
      ...
      return (this.section.maxHeight ? this.section.maxHeight : maxColumnHeight) + this.section.border.verticalHeight();
    }
  }, {
    key: "padText",
