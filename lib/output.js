...
var _text = _interopRequireDefault(require("emoji-regex/es2015/text.js"));
...
function textColumnCount(text) {
  var characters = (0, _stripAnsi.default)(text);
  var fullWidthCharacterCount = 0; // emojis technically consist of 2 characters of unicode, but only take up
  // 1 column of output, so we need to account for that

  var regex = (0, _text.default)();
  var match;
